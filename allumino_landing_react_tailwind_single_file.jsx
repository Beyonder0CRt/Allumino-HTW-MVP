...
const HERO_IMG = new URL(
  "./WhatsApp Image 2025-10-04 at 15.46.18 (1).jpeg",
  import.meta.url
).href; // hero (gaming event)
const LAPTOP_SCREEN_IMG = new URL(
  "./WhatsApp Image 2025-10-04 at 15.46.18 (2).jpeg",
  import.meta.url
).href; // dashboard/screen
const STUDENT_IMG = new URL(
  "./WhatsApp Image 2025-10-04 at 15.46.18 (3).jpeg",
  import.meta.url
).href; // student photo
const EDUCATION_IMG = new URL(
  "./WhatsApp Image 2025-10-04 at 15.46.18 (4).jpeg",
  import.meta.url
).href; // education/laptop block
const PHONE_SCENE_IMG = new URL(
  "./WhatsApp Image 2025-10-04 at 15.46.18.jpeg",
  import.meta.url
        ...
        <header className="sticky top-0 z-50 w-full border-b border-black/5 bg-white/80 backdrop-blur">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <a className="hidden rounded-full px-4 py-2 text-sm font-semibold hover:bg-black/5 md:inline-block" href="#signup">
                Sign Up
              </a>
              <a className="rounded-full bg-gradient-to-r from-[#fba919] to-[#ff8a00] px-5 py-2 text-sm font-semibold text-white shadow hover:opacity-95" href="#login">
                Login
              </a>
            ...
            <div className="relative">
              ...
              <div className="ml-6 sm:ml-10 p-0">
                ...
                <div className="mt-8 flex items-center gap-4">
                  ...
                  <a href="#assessment" className="inline-flex items-center rounded-full bg-gradient-to-r from-[#fba919] to-[#ff8a00] px-6 py-2 font-semibold text-white shadow">here <span className="ml-2">←</span></a>
                </div>
              </div>
            </div>
            <div className="relative">
        ...
        <Section className="pt-0">
          <div className="grid items-center gap-8 rounded-[2rem] border border-black/10 bg-white p-10 shadow-sm md:grid-cols-2">
            ...
            <div className="order-1 md:order-2">
              ...
              <a href="#why" className="mt-6 inline-flex items-center rounded-full bg-gradient-to-r from-[#fba919] to-[#ff8a00] px-6 py-3 font-semibold text-white shadow">
