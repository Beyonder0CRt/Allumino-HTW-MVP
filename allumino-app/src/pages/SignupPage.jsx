...
export default function SignupPage() {
  return (
    <div className="min-h-screen relative bg-[radial-gradient(1200px_600px_at_20%_0%,rgba(255,255,255,0.08)_0%,transparent_60%),linear-gradient(135deg,#0f172a_0%,#0b1222_50%,#151a27_100%)] text-white">
      {/* Brand row */}
      ...
      <div className="mx-auto max-w-7xl px-6 pb-20">
        <div className="mx-auto mt-4 w-full max-w-3xl md:max-w-2xl lg:max-w-3xl">
          <div className="relative overflow-hidden rounded-2xl bg-white/90 text-slate-900 shadow-2xl ring-1 ring-black/10">
            {/* Top strip */}
            <div className="rounded-t-2xl bg-gradient-to-r from-[#fba919] to-[#ff8a00] px-6 py-4 text-left text-lg font-bold text-white shadow-[inset_0_-1px_0_rgba(255,255,255,0.3)]">
              Create an account
            </div>

            <div className="px-8 py-6">
              <h2 className="text-xl font-semibold text-slate-900">Welcome to Allumino</h2>
              <p className="mt-1 text-sm text-slate-600">Let’s get you started!</p>
              ...
              <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300/80 bg-white px-4 py-3 text-slate-900 placeholder:text-slate-400 outline-none focus:border-[#ff9d33] focus:shadow-[0_0_0_3px_rgba(255,157,51,.25)]"
                    />
                  </div>
                  <div>
                ...
                <div className="border-t border-slate-200 pt-4 text-center text-sm text-slate-700">
                  ...
                  <Link to="/login" className="text-[#5b77ff] hover:underline">
                    Log in
                  </Link>
                </div>
              </form>
